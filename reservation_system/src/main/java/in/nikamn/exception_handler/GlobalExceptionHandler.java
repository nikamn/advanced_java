package in.nikamn.exception_handler;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<?> handleMethodArgumentNotValidException(MethodArgumentNotValidException e) {
        System.out.println("In handleMethodArgumentNotValidException: " + e);
    ...
    public ApiResponse handleResourceNotFoundException(
        ...
        System.out.println("In handleResourceNotFoundException: " + e);
    ...
    public ApiResponse handleAnyException(RuntimeException e) {
        System.out.println("In handleAnyException: " + e);
        return new ApiResponse(e.getMessage());
    }
}
